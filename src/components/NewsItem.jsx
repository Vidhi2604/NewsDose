    ...
    return (
      <div className="card bg-dark text-light mb-3 d-inline-block my-3 mx-3 px-2 py-2" style={{maxWidth:"300px"}}>
        ...
        <div className="card-body">
          ...
          <p className="card-text">{description?description.slice(0,90):"There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain..."}</p>
